...
$(function(){
    ...
    $('.product-features-base').find('.img-switch  img').click(function(event) {
        var bigImg = $(this).data('img');
        $('.product-features-base').find('.bigImg').attr('src', bigImg);
    });
});
